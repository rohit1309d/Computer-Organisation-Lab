...
HD_PWD='D:/Xilinx/Projects/ass3_left_shift_multiplier/ass3_left_shift_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unsigned_seq_mult_LS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source unsigned_seq_mult_LS.tcl
