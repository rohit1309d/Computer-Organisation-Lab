...
HD_PWD='D:/Xilinx/Projects/ass3_right_shift_multiplier/ass3_right_shift_multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log unsigned_seq_mult_RS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source unsigned_seq_mult_RS.tcl -notrace
