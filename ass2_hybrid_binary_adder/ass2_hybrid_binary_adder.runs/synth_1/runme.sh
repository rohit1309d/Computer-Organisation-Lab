...
HD_PWD='D:/Xilinx/Projects/ass2_hybrid_binary_adder/ass2_hybrid_binary_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hybrid_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hybrid_adder.tcl
